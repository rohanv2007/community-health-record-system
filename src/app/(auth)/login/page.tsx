...
export default function LoginPage() {
  ...
  return (
    <main className="grid min-h-screen bg-sidebar lg:grid-cols-[1.02fr_0.98fr]">
      <section className="relative hidden overflow-hidden p-10 text-white lg:flex lg:flex-col lg:justify-between">
        <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(8,17,31,0.98),rgba(15,32,51,0.94))]" />
        ...
        <div className="relative z-10 max-w-2xl">
          <p className="text-sm font-semibold uppercase text-teal-200">Community care, coordinated</p>
          ...
          <div className="mt-8 grid grid-cols-3 gap-3 text-sm text-slate-200">
            <div className="rounded-lg border border-white/10 bg-white/[0.04] p-4">RLS secured by clinic</div>
            <div className="rounded-lg border border-white/10 bg-white/[0.04] p-4">Role-aware workflows</div>
            <div className="rounded-lg border border-white/10 bg-white/[0.04] p-4">Live Supabase backend</div>
          </div>
        </div>
      </section>
      <section className="flex items-center justify-center bg-background p-6">
        <Card className="w-full max-w-md">
          <CardContent className="p-6">
            <div className="mb-6">
              <p className="text-sm font-semibold uppercase text-teal">Secure sign in</p>
            ...
            <div className="mt-6 rounded-lg border bg-muted/45 p-3">
              <p className="mb-2 text-xs font-semibold uppercase text-muted-foreground">Demo credentials</p>
